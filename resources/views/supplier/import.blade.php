<form action="{{ url('/supplier/import_ajax') }}" method="POST" id="form-import-supplier" enctype="multipart/form-data">
    @csrf
    <div id="modal-master-supplier" class="modal-dialog modal-lg" role="document">
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status) {
                            $('#modal-master-supplier').modal('hide');
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil',
                                text: response.message
                            });
                            // Jika pakai DataTables, ganti 'tableSupplier' dengan variabel table yang kamu gunakan
